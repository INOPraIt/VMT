...
export default handleActions({
  [getUserOwnRolesAsync.success]: (s, a) => (
    {
      ...s, state: a.payload.data && a.payload.data.success ? a.payload.data.roles : [],
  ...
  [getUserOwnRolesAsync.failed]:
    (s, a) =>
      ({ ...s, state: [], error: 'Что-то пошло не так' }),

      
  [createRoleAsync.success]:
    (s, a) =>
      ({ ...s, state: a.payload.data && a.payload.data.success ? 
        [...s.state, a.payload.data.role] : [], error: a.payload.data && a.payload.data.success ? 
        null : a.payload.data && a.payload.data.error ? 
        a.payload.data.error : 'Что-то пошло не так' 
      }),
  ...
  [deleteRoleAsync.success]: (s, a) => (
    { ...s, state: a.payload.data && a.payload.data.success ? s.state.filter(v => v._id != a.payload.data.role) : [], 
