...
export default handleActions({
  ...
  [searchUsersAsync.success]: (s, a) => (
    { ...s, 
      searched: a.payload.data && a.payload.data.success ? a.payload.data.users : [], 
  ...
  [searchUsersAsync.failed]: (s, a) => (
    { ...s, 
      state: null, 
      error: 'Что-то пошло не так' 
    }),
  [clearAllUserErrorsAsync.success]: (s, a) => (
    { ...s, 
      error: null 
    }),
  [clearAllUserErrorsAsync.failed]: (s, a) => (
    { ...s, 
      error: null 
    }),
}, initialState);
